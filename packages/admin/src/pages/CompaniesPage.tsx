...
import type { Company, CompanyType, CreateCompanyPayload } from '@lng/shared';
                  ...
                  <td className="py-3">
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className={`rounded p-1 ${c.is_active ? 'text-gray-400 hover:text-red-600' : 'text-gray-400 hover:text-green-600'}`}
