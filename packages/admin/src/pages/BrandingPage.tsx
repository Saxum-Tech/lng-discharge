...
import type { AppSettings, UpdateAppSettingsPayload } from '@lng/shared';
      ...
      {loading ? (
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <form onSubmit={handleSave} className="space-y-6 lg:col-span-2">
            <Card>
              <CardHeader><CardTitle>App identity</CardTitle></CardHeader>
            ...
            <Button type="submit" loading={saving} size="lg">Save branding</Button>
          </form>
          ...
          <div className="hidden lg:block">
            <Card className="sticky top-8">
              ...
              <div
                ...
                style={{ '--preview-primary': primaryColor, '--preview-accent': accentColor } as React.CSSProperties}
              >
                {/* Simulated navbar */}
